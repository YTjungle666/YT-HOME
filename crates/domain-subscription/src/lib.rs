...
mod tests {
    ...
    fn clash_subscription_preserves_reality_fields() {
        ...
        assert_eq!(proxy["server"], "192.0.2.10");
        assert_eq!(proxy["port"], 29974);
        assert_eq!(proxy["servername"], "edge.example.com");
    ...
    fn vless_links_omit_empty_reality_short_id() {
        ...
        assert_eq!(
            links,
            vec![
                "vless://44444444-4444-4444-4444-444444444444@192.0.2.10:29974?type=tcp&security=reality&pbk=public-key&fp=chrome&sni=edge.example.com&flow=xtls-rprx-vision#lan"
            ]
        );
    }
